...
define('WPM_TEXT_DOMAIN', 'woocommerce-production-manager');

// Check if WooCommerce is active
if (!in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
    add_action('admin_notices', function() {
        echo '<div class="error"><p>' . esc_html__('WooCommerce Production Manager requires WooCommerce to be installed and active.', WPM_TEXT_DOMAIN) . '</p></div>';
    });
    return;
}
